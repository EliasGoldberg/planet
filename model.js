...
(function() {
  this.Model = (function() {
    ...
    Model.prototype.tessellate = function(subdivisions, midpointFunction) {
      var face, k, len, newFaces, ref, subFaces;
      newFaces = [];
      ref = this.faces;
      for (k = 0, len = ref.length; k < len; k++) {
        face = ref[k];
    ...
    Model.prototype.addFaces = function(faces) {
      var bary, fIdx, face, i, k, len, results1, vertex;
      results1 = [];
      for (fIdx = k = 0, len = faces.length; k < len; fIdx = ++k) {
        face = faces[fIdx];
        ...
        results1.push((function() {
          ...
          for (i = l = 0; l <= 2; i = ++l) {
            ...
            if (!this.vertexExists(vertex)) {
              ...
              face.setBary(bary, i);
              this.vertices = this.vertices.concat(vertex.elements()).concat(bary).concat([fIdx]);
    ...
    Model.prototype.removeFaces = function(faces) {
      var face, i, index, k, l, laterIndex, laterIndexIndices, laterIndexVtoIMap, len, len1, len2, location, m, otherFace, otherLocation, ref, ref1, ref2, results1, v, vertex, vertexRefCountToZero;
        ...
        results1.push((function() {
          ...
          for (otherFace in ref3) {
            ...
            if (otherLocation > location) {
              results2.push(this.faceToIndexLocationMap[otherFace] = otherLocation - 3);
            }
          }
          return results2;
        }).call(this));
